          ...
          if (r)
              if (a && s && o) {
                  ...
                  var C = new e.ShaderMaterial({
                      ...
                      D = new e.Mesh(b, C);
                  x.add(D), g && (j.addEventListener("mouseenter", _), j.addEventListener("touchstart", _), j.addEventListener("mouseleave", z), j.addEventListener("touchend", z)), window.addEventListener("resize", function(t) {
