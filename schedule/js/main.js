...
const dragAndDropConfirmationQuestionServiceResource = document.querySelector('.drag-and-drop-confirmation__questions-item_service-resource')
...
document.addEventListener("mouseup", function (event) {
  if(is_drag===1){
    ...
    if(appontment_for_drag.getAttribute('data-appointment-notification') ==='true'){
      dragAndDropConfirmationQuestionServiceResource.style.display = 'block'
    } else {
      dragAndDropConfirmationQuestionServiceResource.style.display = 'none'
    }
